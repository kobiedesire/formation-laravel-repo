            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <ul class="navbar-nav  mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" style="margin-right:60px !important;" aria-haspopup="true" aria-expanded="false">Connexion</a>
                        ...
                        @else
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" style="margin-right:60px !important;" aria-haspopup="true" aria-expanded="false">{{Auth::user()->name}}</a>
                        <div class="dropdown-menu" aria-labelledby="dropdownId">
                            <a class="dropdown-item" href="{{route('produit.ajout')}} ">Ajouter</a>
